...
public class SportsSeasonManager : MonoBehaviour
{
    ...
    /// </summary>
    public float GetDemandMultiplier(SportsCard.CardSport sport)
    {
        return ActiveSeason switch
        {
            SportsSeason.Basketball_Playoffs => sport switch
            {
                SportsCard.CardSport.Basketball => 1.50f,
                SportsCard.CardSport.Baseball   => 0.80f,
                _                               => 1.00f,
            },
            SportsSeason.Football_Kickoff => sport switch
            {
                SportsCard.CardSport.Football   => 1.60f,
                SportsCard.CardSport.Hockey     => 0.85f,
                _                               => 1.00f,
            },
            SportsSeason.Baseball_Summer => sport switch
            {
                SportsCard.CardSport.Baseball   => 1.45f,
                SportsCard.CardSport.Football   => 0.75f,
                _                               => 1.00f,
            },
            SportsSeason.Hockey_Winter => sport switch
            {
                SportsCard.CardSport.Hockey     => 1.55f,
                SportsCard.CardSport.Basketball => 1.10f,
                _                               => 1.00f,
            },
            _ => 1.00f,
        };
